  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(230,184,0,0.08) 0%, transparent 70%)",
        }}
      />
...
/>
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="h-px w-16 md:w-24" style={{ background: "linear-gradient(90deg, transparent, #E6B800)" }} />
          <span className="text-sm tracking-[0.3em] uppercase" style={{ color: "#E6B800" }}>
            Servicios de Pintura
          </span>
          <div className="h-px w-16 md:w-24" style={{ background: "linear-gradient(90deg, #E6B800, transparent)" }} />
        </div>

        {/* Subtítulo */}
        <p className="text-base md:text-lg mb-10 tracking-wide max-w-lg"
